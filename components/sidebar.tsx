		...
		<div className="text-white space-y-4 py-4 flex flex-col h-full bg-[#111827]">
			<div className="px-3 py-2 flex-1">
				...
				<div className="space-y-1">
					{routes.map((route) => (
						<Link key={route.href} href={route.href} className={cn("text-sm group flex p-3 w-full justify-start font-medium cursor-pointer hover:text-white hover:bg-white/10 rounded-lg", pathname === route.href ? "text-white bg-white/10" : "text-zinc-400")}>
